...
// }
import $ from 'jquery';
import { Buffer, Color, Line, Station, Item } from './models';
...
interface SimulationOptions {
  autoAddInput: boolean;
  autoRemoveOutput: boolean;
...
class Simulation {
  ...
  readonly messages: {
	...
	handleMouseInput(mou: Mouse): void {
